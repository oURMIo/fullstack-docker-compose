...
const EditUserModal = ({ values, onChange, handleEditUser, pageToggleModal }) => {
    return (
          ...
          <form onSubmit={handleEditUser}>
            <div className="user-details">
              ...
              <div className="input-box">
                ...
                <input type="text" value={values.supervisor} onChange={onChange} name='supervisor' required />
              </div>
            </div>
            <div className="form_footer">
              <button onClick={() => pageToggleModal(false)} type='button' className="btn btn-danger">Cancel</button>
