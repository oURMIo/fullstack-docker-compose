                    ...
                    <form onSubmit={onUpdateUser} className="form">
                        <div className="user-details">
                            ...
                            <div className="input-box">
                                ...
                                <input type="text" value={user.firatName} onChange={onChange} name="firatName" required />
                            </div>
                            <div className="input-box">
                            ...
                            <div className="input-box">
                                ...
                                <input type="text" value={user.position} onChange={onChange} name="position" required />
                            </div>
                            <div className="input-box">
                                <span className="details">supervisor</span>
                                <input type="text" value={user.supervisor} onChange={onChange} name="supervisor" required />
                            </div>
                            <div className="input-box">
                                <span className="details">creationDate</span>
                                <input type="text" value={user.creationDate} onChange={onChange} name="creationDate" required />
                            </div>
